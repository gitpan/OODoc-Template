...
$obj-E<gt>B<process>(STRING|SCALAR|ARRAY, HASH|PAIRS)
...
$obj-E<gt>B<processFile>(FILENAME, HASH|PAIRS)
...
$obj-E<gt>B<allValuesFor>(TAG, [ATTRIBUTES, THEN, ELSE])
...
$obj-E<gt>B<defineMacro>(TAG, ATTRIBUTES, THEN, ELSE)

=over 4

=back

$obj-E<gt>B<includeTemplate>(TAG, ATTRIBUTES, THEN, ELSE)
...
$obj-E<gt>B<valueFor>(TAG, [ATTRIBUTES, THEN, ELSE])
...
$obj-E<gt>B<parse>(STRING, (HASH|PAIRS))
...
$obj-E<gt>B<parseTemplate>(STRING)
...
This module is part of OODoc-Template distribution version 0.13,
built on February 04, 2008. Website: F<http://perl.overmeer.net/oodoc-template/>

=head1 LICENSE

Copyrights 2003,2007-2008 by Mark Overmeer. For other contributors see ChangeLog.
